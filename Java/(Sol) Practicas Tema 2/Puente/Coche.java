        ...
        if (norte) {
            if (prioritario) {
                try {
                    ...
                    System.out.println("La Policía " + id + " ha entrado en el puente lado NORTE");
                    sleep(random(1000, 2000));
                    cont.salS();
                    System.out.println("La Policía " + id + " ha salido en el puente lado SUD");
            ...
            if (prioritario) {
                try {
                    ...
                    System.out.println("La Policía " + id + " ha entrado en el puente lado SUD");
                    sleep(random(1000, 20000));
                    cont.SaleN();
                    System.out.println("La Policía " + id + " ha salido en el puente lado NORTE");
                } catch (InterruptedException ex) {
                }
            } else {
                try {
